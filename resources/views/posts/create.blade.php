 ...
 --}}
 				...
 				<form>
			        ...
			        <fieldset class="uk-fieldset">
					    ...
					    <div class="uk-margin" uk-margin>
					     ...
					     <div class="uk-margin">
				            <textarea class="uk-textarea" rows="20" cols="10" id="post-body" placeholder="Your Story here..."></textarea>
				        </div>
	 ...
	 <script>
	    var editor_config = {
	        ...
	        toolbar: "insertfile  | styleselect | bold italic | aligncenter | bullist | link image | ",
	        content_css: [
    '//fonts.googleapis.com/css?family=Lato:300,300i,400,400i',
    '//www.tinymce.com/css/codepen.min.css'],
	        relative_urls: false,
